...
const BlogPage = () => {
  ...
  return (
    <div className="page flex flex-col items-center pt-4 bg-gray-100 overflow-x-hidden min-h-screen justify-between">
          ...
          <div className="flex flex-col justify-start gap-3">
            ...
            <div className="flex gap-2 text-sm font-semibold ">
              ...
              <span className="text-gray-400 ">
                <span>{blog ? blog.publishedAt.slice(0, 10) : "10/28/12"}</span>
              </span>
            </div>
          </div>
      ...
      {blog ? (
        <div className="px-4 md:px-36 py-1 pb-2 flex flex-col items-center gap-8 text-sm text-gray-500">
        ...
        <div className="px-4 md:px-36 py-1 flex flex-col items-center gap-8 text-sm text-gray-500">
          ...
          culpa qui officia deserunt mollit anim id est laborum. */}
            {blog ? blog.Blog_description : "hskfj"}
          </p>
          <hr className="w-full" />
          ...
          <div className="flex flex-col gap-2 border-l-2 border-fuchsia-600 p-4 font-bold">
            <p className="italic text-black text-lg">
              "In a world more older and complete than ours they move finished
          ...
          <p>
            Dui accumsan sit amet nulla facilisi morbi. Egestas dui id ornare
            arcu odio ut. Mauris a diam maecenas sed enim ut sem viverra
            aliquet. Tempus imperdiet nulla malesuada pellentesque elit eget
            gravida cum sociis.
          </p>
          <p>
            ...
            pellentesque elit ullamcorper dignissim. Nulla malesuada
            pellentesque elit eget gravida cum sociis natoque penatibus. In
          ...
          <div className="w-full flex flex-col gap-2">
            ...
            <p>
              ...
              mauris ultrices eros in cursus. Vestibulum rhoncus est
              pellentesque elit ullamcorper dignissim. Nulla malesuada
              pellentesque elit eget gravida cum sociis natoque penatibus. In
              vitae turpis massa sed elementum tempus egestas sed sed.
            </p>
            <ol>
              ...
              <li>
                ...
                volupat elit, ultrices suspendisse. Aucutor vel in vitae
                placerat.{" "}
              </li>
              <li>
          ...
          <p>
            ...
            elementum tempus egestas sed sed. Morbi tincidunt augue interdum
            velit euismod. Porta lorem mollis aliquam ut porttitor leo a. Est
          ...
          <p>
            ...
            penatibus. In vitae turpis massa sed elementum tempus egestas sed
            sed. Libero nunc consequat interdum varius. Placerat vestibulum
            lectus mauris ultrices eros in cursus. Vestibulum rhoncus est
          ...
          <div className="flex flex-col gap-4 bg-white p-5 md:p-10 rounded-lg">
            ...
            <p>
              ...
              augue ut lectus. Erat velit scelerisque in dictum non consectetur
              a erat nam. Nulla facilisi cras fermentum odio eu feugiat.
            </p>
            <p>
            ...
            <p>
              ...
              nascetur ridiculus mus mauris vitae ultricies leo integer. Diam
              quis enim lobortis scelerisque fermentum dui. Adipiscing elit duis
